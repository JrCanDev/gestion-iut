...
@login_required
def managedPlanning(request, year_id):
  ...
  return render(request, 'management/managed-planning.html', {'week': week, 'year': year, 'remaining_session': remaining_session})
...
@login_required
def deletePlanning(request, year_id, planning_id):
