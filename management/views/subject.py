...
@login_required
def managedSubject(request, promotion_id, subject_id):
  '''
  ...
  return render(request, 'management/managed-subject.html', {'promotion': promotion, 'subject': subject, 'nb_sessions': nb_sessions, "session_td": session_td, "session_tp": session_tp})

@login_required
def deleteSubject(request, promotion_id, subject_id):
